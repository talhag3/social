<?php
	...
	if(isset($_POST['tweet'])){
		...
		if(!empty($status) or !empty($_FILES['file']['name'][0])){
			...
			$tweet_id = $getFromU->create('tweets',array('status' => $status, 'tweetBy' => $user_id, 'tweetImage' => $tweetImage, 'postedOn' => date('d-m-Y H:i:s')));
	...
	<!--==TRENDS==-->
 	...
 	<!--==TRENDS==-->
		...
		<div class="in-center">
			...
			<script type="text/javascript" src="assets/js/retweets.js"></script>
