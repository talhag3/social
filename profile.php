	...
	<div class="nav-container">
		...
		<div class="nav-right">
			<ul>
				...
				<?php }else{
					echo '<li><a href="'.BASE_URL.'index.php">Have a account? Log In</a></li>';
				} ?>
			</ul>
		</div><!-- nav right ends-->
	...
	<div class="profile-extra-inner">
		...
		<?php if(!empty($profileData->website)){?>
			<li>
				...
				<div class="profile-ex-location">
					<a href="<?php echo $profileData->website;?>" target="_blink"></textarea><?php echo $profileData->website;?></a>
				</div>
			</li>
		<?php } ?>
			<li>
...
<div class="in-center">
									...
									<div class="retweet-t-s-b-inner-left">
										...
										<div>
											<div class="t-h-c-name">
												...
												<span>'.$getFromUt->timeAgo($tweet->postedOn).'</span>
											</div>
  ...
  <div class="popupTweet"></div>
	...
	<script type="text/javascript" src="<?php echo BASE_URL;?>assets/js/retweets.js"></script>
