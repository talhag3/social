<?php
    ...
    if(isset($_POST['showChatMessages']) && !empty($_POST['showChatMessages'])){
        $user_id = $_SESSION['user_id'];
        $messageFrom = $_POST['showChatMessages'];
    ...
    if(isset($_POST['showMessage']) && !empty($_POST['showMessage'])){
        ...
        <div class="message-send">
            ...
            <div class="message-body">
                <h4>Recent</h4>
                <div class="message-recent" data-user="<?php echo $message->$user_id; ?>">
